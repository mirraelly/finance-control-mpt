package com.mpt.financecontrol.contareceberparcela.entity;
...
public class ContaReceberParcela extends BaseEntity {
    ...
    @OneToMany(mappedBy = "contaReceberParcela", fetch = FetchType.LAZY)
